...
function updateThemeIcon() {
    if (elements.themeIcon) {
        elements.themeIcon.className = state.theme === 'dark' ? 'fas fa-moon' : 'fas fa-sun';
    }
}
...
function initTypewriter() {
    ...
    function type() {
        ...
        if (isDeleting) {
            elements.typewriter.textContent = currentString.substring(0, charIndex - 1);
            charIndex--;
        } else {
            elements.typewriter.textContent = currentString.substring(0, charIndex + 1);
            charIndex++;
...
function initAnimations() {
    ...
    document.querySelectorAll('.fade-in, .slide-in, .stat-value').forEach(el => {
        observer.observe(el);
    });
}
    ...
    const experiences = [
        {
            ...
            category: 'software',
            description: 'Liderando desarrollo de software para creación masiva de planos, implementación de ML para detección de zonas de riesgo geológico.',
            achievements: ['700+ planos en minutos', 'Web Scraping MTC', 'Machine Learning'],
        ...
        },
        {
            ...
            company: 'INARQ',
            category: 'teaching',
            description: 'Programa especializado en Minería 4.0: Innovación e implementación IA.',
        ...
        },
        {
            ...
            category: 'software',
            description: 'Lideré equipo de Operaciones, gestionando proyectos de ML para minería.',
            achievements: ['15 analistas formados', 'ML en sostenimiento', 'Sistema gestor de aceros'],
            tech: ['Python', 'Power BI', 'SQL Server', 'Scrum']
        }
    ];
    
    timeline.innerHTML = experiences.map((exp, index) => `
        <div class="timeline-item ${index % 2 === 0 ? 'left' : 'right'}" data-category="${exp.category}">
    ...
    const projects = [
        {
            ...
            category: 'automation',
            description: 'Automatización para generar 700+ planos en minutos con ML para riesgo geológico',
        ...
        },
        {
            ...
            category: 'ml',
            description: 'Modelo predictivo para selección óptima de sostenimiento en minas',
        ...
        },
        {
            ...
            category: 'mining',
            description: 'Software para cálculo de cobertura de aire según DS 023-2017 EM',
...
async function loadCertifications() {
    ...
    certSlider.innerHTML = certifications.map(cert => `
        <div class="cert-card">
